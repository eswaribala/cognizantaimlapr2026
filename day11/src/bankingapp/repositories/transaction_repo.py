...
class TransactionRepository(ABC):
    @abstractmethod
    def create_transaction(self, transaction:TransactionRequest)->TransactionResponse:
        pass
    ...
    @abstractmethod
    def update_transaction(self, transaction:TransactionRequest)->TransactionResponse:
        pass
